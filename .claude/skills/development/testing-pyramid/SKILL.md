---
description: Create a testing pyramid with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir testing pyramid oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut testing pyramid belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- testing pyramid yapılandırmak için seçilen çerçeveyi uygula
...
- testing pyramid aşağıdaki çıktı formatını kullanarak yapılandır
