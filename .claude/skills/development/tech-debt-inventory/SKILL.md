---
description: Create a tech debt inventory with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir tech debt inventory oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut tech debt inventory belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- tech debt inventory yapılandırmak için seçilen çerçeveyi uygula
...
- tech debt inventory aşağıdaki çıktı formatını kullanarak yapılandır
