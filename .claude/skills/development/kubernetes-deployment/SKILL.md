---
description: Create a kubernetes deployment with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir kubernetes deployment oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut kubernetes deployment belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- kubernetes deployment yapılandırmak için seçilen çerçeveyi uygula
...
- kubernetes deployment aşağıdaki çıktı formatını kullanarak yapılandır
