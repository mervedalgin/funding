---
description: Create a event driven architecture with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir event driven architecture oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut event driven architecture belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- event driven architecture yapılandırmak için seçilen çerçeveyi uygula
...
- event driven architecture aşağıdaki çıktı formatını kullanarak yapılandır
