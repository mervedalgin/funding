---
description: Create a infrastructure as code with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir infrastructure as code oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut infrastructure as code belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- infrastructure as code yapılandırmak için seçilen çerçeveyi uygula
...
- infrastructure as code aşağıdaki çıktı formatını kullanarak yapılandır
