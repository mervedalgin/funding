---
description: Analyze and produce a monitoring setup with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir monitoring setup analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut monitoring setup belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- monitoring setup yapılandırmak için seçilen çerçeveyi uygula
...
- monitoring setup aşağıdaki çıktı formatını kullanarak yapılandır
