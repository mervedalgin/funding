---
description: Create a codebase walkthrough with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir codebase walkthrough oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut codebase walkthrough belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- codebase walkthrough yapılandırmak için seçilen çerçeveyi uygula
...
- codebase walkthrough aşağıdaki çıktı formatını kullanarak yapılandır
