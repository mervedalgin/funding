---
description: Create a developer onboarding with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir developer onboarding oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut developer onboarding belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- developer onboarding yapılandırmak için seçilen çerçeveyi uygula
...
- developer onboarding aşağıdaki çıktı formatını kullanarak yapılandır
