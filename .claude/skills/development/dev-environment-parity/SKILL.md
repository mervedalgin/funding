---
description: Create a dev environment parity with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir dev environment parity oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut dev environment parity belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- dev environment parity yapılandırmak için seçilen çerçeveyi uygula
...
- dev environment parity aşağıdaki çıktı formatını kullanarak yapılandır
