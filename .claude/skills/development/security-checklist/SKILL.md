...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir security checklist analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut security checklist belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- security checklist yapılandırmak için seçilen çerçeveyi uygula
...
- security checklist aşağıdaki çıktı formatını kullanarak yapılandır
