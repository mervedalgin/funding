---
description: Design and document a ci cd pipeline with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ci cd pipeline tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ci cd pipeline belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ci cd pipeline yapılandırmak için seçilen çerçeveyi uygula
...
- ci cd pipeline aşağıdaki çıktı formatını kullanarak yapılandır
