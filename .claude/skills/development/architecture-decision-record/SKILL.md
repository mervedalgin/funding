---
description: Create a architecture decision record with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir architecture decision record oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut architecture decision record belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- architecture decision record yapılandırmak için seçilen çerçeveyi uygula
...
- architecture decision record aşağıdaki çıktı formatını kullanarak yapılandır
