---
description: Create a semantic versioning with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir semantic versioning oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut semantic versioning belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- semantic versioning yapılandırmak için seçilen çerçeveyi uygula
...
- semantic versioning aşağıdaki çıktı formatını kullanarak yapılandır
