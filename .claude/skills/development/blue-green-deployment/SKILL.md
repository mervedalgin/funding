---
description: Create a blue green deployment with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir blue green deployment oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut blue green deployment belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- blue green deployment yapılandırmak için seçilen çerçeveyi uygula
...
- blue green deployment aşağıdaki çıktı formatını kullanarak yapılandır
