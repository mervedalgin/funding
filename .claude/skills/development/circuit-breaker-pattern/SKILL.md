---
description: Create a circuit breaker pattern with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir circuit breaker pattern oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut circuit breaker pattern belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- circuit breaker pattern yapılandırmak için seçilen çerçeveyi uygula
...
- circuit breaker pattern aşağıdaki çıktı formatını kullanarak yapılandır
