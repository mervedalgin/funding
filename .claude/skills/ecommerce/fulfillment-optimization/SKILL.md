---
description: Create a fulfillment optimization with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir fulfillment optimization oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut fulfillment optimization belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- fulfillment optimization yapılandırmak için seçilen çerçeveyi uygula
...
- fulfillment optimization aşağıdaki çıktı formatını kullanarak yapılandır
