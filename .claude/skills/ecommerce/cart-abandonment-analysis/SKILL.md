---
description: Analyze and produce a cart abandonment analysis with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir cart abandonment analysis analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut cart abandonment analysis belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- cart abandonment analysis yapılandırmak için seçilen çerçeveyi uygula
...
- cart abandonment analysis aşağıdaki çıktı formatını kullanarak yapılandır
