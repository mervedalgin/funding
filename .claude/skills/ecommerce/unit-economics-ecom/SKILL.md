---
description: Create a unit economics ecom with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir unit economics ecom oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut unit economics ecom belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- unit economics ecom yapılandırmak için seçilen çerçeveyi uygula
...
- unit economics ecom aşağıdaki çıktı formatını kullanarak yapılandır
