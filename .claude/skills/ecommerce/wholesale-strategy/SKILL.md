---
description: Design and document a wholesale strategy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir wholesale strategy tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut wholesale strategy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- wholesale strategy yapılandırmak için seçilen çerçeveyi uygula
...
- wholesale strategy aşağıdaki çıktı formatını kullanarak yapılandır
