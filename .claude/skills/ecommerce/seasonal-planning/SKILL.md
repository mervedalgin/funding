---
description: Design and document a seasonal planning with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir seasonal planning tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut seasonal planning belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- seasonal planning yapılandırmak için seçilen çerçeveyi uygula
...
- seasonal planning aşağıdaki çıktı formatını kullanarak yapılandır
