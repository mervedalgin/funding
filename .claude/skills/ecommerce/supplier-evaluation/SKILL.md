---
description: Analyze and produce a supplier evaluation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir supplier evaluation analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut supplier evaluation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- supplier evaluation yapılandırmak için seçilen çerçeveyi uygula
...
- supplier evaluation aşağıdaki çıktı formatını kullanarak yapılandır
