---
description: Create a ecommerce analytics with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ecommerce analytics oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ecommerce analytics belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ecommerce analytics yapılandırmak için seçilen çerçeveyi uygula
...
- ecommerce analytics aşağıdaki çıktı formatını kullanarak yapılandır
