---
description: Create a recommendation engine with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir recommendation engine oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut recommendation engine belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- recommendation engine yapılandırmak için seçilen çerçeveyi uygula
...
- recommendation engine aşağıdaki çıktı formatını kullanarak yapılandır
