---
description: Design and document a stakeholder interview guide with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir stakeholder interview guide tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut stakeholder interview guide belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- stakeholder interview guide yapılandırmak için seçilen çerçeveyi uygula
...
- stakeholder interview guide aşağıdaki çıktı formatını kullanarak yapılandır
