---
description: Design and document a transformation roadmap with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir transformation roadmap tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut transformation roadmap belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- transformation roadmap yapılandırmak için seçilen çerçeveyi uygula
...
- transformation roadmap aşağıdaki çıktı formatını kullanarak yapılandır
