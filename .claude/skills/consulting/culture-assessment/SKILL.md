---
description: Analyze and produce a culture assessment with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir culture assessment analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut culture assessment belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- culture assessment yapılandırmak için seçilen çerçeveyi uygula
...
- culture assessment aşağıdaki çıktı formatını kullanarak yapılandır
