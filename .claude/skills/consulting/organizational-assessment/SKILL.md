---
description: Analyze and produce a organizational assessment with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir organizational assessment analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut organizational assessment belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- organizational assessment yapılandırmak için seçilen çerçeveyi uygula
...
- organizational assessment aşağıdaki çıktı formatını kullanarak yapılandır
