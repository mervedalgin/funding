---
description: Create a client discovery workshop with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir client discovery workshop oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut client discovery workshop belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- client discovery workshop yapılandırmak için seçilen çerçeveyi uygula
...
- client discovery workshop aşağıdaki çıktı formatını kullanarak yapılandır
