---
description: Design and document a implementation roadmap with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir implementation roadmap tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut implementation roadmap belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- implementation roadmap yapılandırmak için seçilen çerçeveyi uygula
...
- implementation roadmap aşağıdaki çıktı formatını kullanarak yapılandır
