---
description: Create a recommendation deck with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir recommendation deck oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut recommendation deck belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- recommendation deck yapılandırmak için seçilen çerçeveyi uygula
...
- recommendation deck aşağıdaki çıktı formatını kullanarak yapılandır
