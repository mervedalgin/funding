---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir review generation plan analiz edin ve üretin
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir review generation plan analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut review generation plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- Seçilen çerçeveyi review generation plan'ı yapılandırmak için uygula
...
- Review generation plan'ı aşağıdaki çıktı formatını kullanarak yapılandır
