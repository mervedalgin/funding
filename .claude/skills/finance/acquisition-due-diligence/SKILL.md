---
description: Create a acquisition due diligence with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir acquisition due diligence oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut acquisition due diligence belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- acquisition due diligence yapılandırmak için seçilen çerçeveyi uygula
...
- acquisition due diligence aşağıdaki çıktı formatını kullanarak yapılandır
