---
description: Analyze and produce a cash flow forecast with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir cash flow forecast analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut cash flow forecast belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- cash flow forecast yapılandırmak için seçilen çerçeveyi uygula
...
- cash flow forecast aşağıdaki çıktı formatını kullanarak yapılandır
