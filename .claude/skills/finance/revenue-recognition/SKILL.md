---
description: Create a revenue recognition with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir revenue recognition oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut revenue recognition belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- revenue recognition yapılandırmak için seçilen çerçeveyi uygula
...
- revenue recognition aşağıdaki çıktı formatını kullanarak yapılandır
