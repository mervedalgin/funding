---
description: Analyze and produce a financial dashboard with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir financial dashboard analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut financial dashboard belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- financial dashboard yapılandırmak için seçilen çerçeveyi uygula
...
- financial dashboard aşağıdaki çıktı formatını kullanarak yapılandır
