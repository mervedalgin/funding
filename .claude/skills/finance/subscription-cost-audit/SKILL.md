---
description: Analyze and produce a subscription cost audit with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir subscription cost audit analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut subscription cost audit belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- subscription cost audit yapılandırmak için seçilen çerçeveyi uygula
...
- subscription cost audit aşağıdaki çıktı formatını kullanarak yapılandır
