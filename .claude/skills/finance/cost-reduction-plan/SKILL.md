---
description: Design and document a cost reduction plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir cost reduction plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut cost reduction plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- cost reduction plan yapılandırmak için seçilen çerçeveyi uygula
...
- cost reduction plan aşağıdaki çıktı formatını kullanarak yapılandır
