---
description: Analyze and produce a kpi scorecard with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir kpi scorecard analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut kpi scorecard belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- kpi scorecard yapılandırmak için seçilen çerçeveyi uygula
...
- kpi scorecard aşağıdaki çıktı formatını kullanarak yapılandır
