---
description: Analyze and produce a financial ratio analysis with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir financial ratio analysis analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut financial ratio analysis belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- financial ratio analysis yapılandırmak için seçilen çerçeveyi uygula
...
- financial ratio analysis aşağıdaki çıktı formatını kullanarak yapılandır
