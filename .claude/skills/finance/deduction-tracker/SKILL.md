---
description: Analyze and produce a deduction tracker with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir deduction tracker analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut deduction tracker belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- deduction tracker yapılandırmak için seçilen çerçeveyi uygula
...
- deduction tracker aşağıdaki çıktı formatını kullanarak yapılandır
