---
description: Create a monte carlo simulation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir monte carlo simulation oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut monte carlo simulation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- monte carlo simulation yapılandırmak için seçilen çerçeveyi uygula
...
- monte carlo simulation aşağıdaki çıktı formatını kullanarak yapılandır
