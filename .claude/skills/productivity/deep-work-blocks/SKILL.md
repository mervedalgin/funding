---
description: Create a deep work blocks with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir deep work blocks oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut deep work blocks belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- deep work blocks yapılandırmak için seçilen çerçeveyi uygula
...
- deep work blocks aşağıdaki çıktı formatını kullanarak yapılandır
