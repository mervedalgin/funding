---
description: Analyze and produce a weighted scoring with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir weighted scoring analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut weighted scoring belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- weighted scoring yapılandırmak için seçilen çerçeveyi uygula
...
- weighted scoring aşağıdaki çıktı formatını kullanarak yapılandır
