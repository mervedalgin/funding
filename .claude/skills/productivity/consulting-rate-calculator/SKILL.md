---
description: Create a consulting rate calculator with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir consulting rate calculator oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut consulting rate calculator belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- consulting rate calculator yapılandırmak için seçilen çerçeveyi uygula
...
- consulting rate calculator aşağıdaki çıktı formatını kullanarak yapılandır
