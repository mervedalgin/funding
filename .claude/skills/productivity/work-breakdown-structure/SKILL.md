---
description: Create a work breakdown structure with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir work breakdown structure oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut work breakdown structure belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- work breakdown structure yapılandırmak için seçilen çerçeveyi uygula
...
- work breakdown structure aşağıdaki çıktı formatını kullanarak yapılandır
