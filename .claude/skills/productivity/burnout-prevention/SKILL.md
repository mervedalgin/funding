---
description: Create a burnout prevention with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir burnout prevention oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut burnout prevention belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- burnout prevention yapılandırmak için seçilen çerçeveyi uygula
...
- burnout prevention aşağıdaki çıktı formatını kullanarak yapılandır
