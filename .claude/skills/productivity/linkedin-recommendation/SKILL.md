---
description: Create a linkedin recommendation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir linkedin recommendation oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut linkedin recommendation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- linkedin recommendation yapılandırmak için seçilen çerçeveyi uygula
...
- linkedin recommendation aşağıdaki çıktı formatını kullanarak yapılandır
