---
description: Design and document a storytelling framework with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir storytelling framework tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut storytelling framework belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- storytelling framework yapılandırmak için seçilen çerçeveyi uygula
...
- storytelling framework aşağıdaki çıktı formatını kullanarak yapılandır
