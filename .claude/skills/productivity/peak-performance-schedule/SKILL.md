---
description: Design and document a peak performance schedule with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir peak performance schedule tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut peak performance schedule belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- peak performance schedule yapılandırmak için seçilen çerçeveyi uygula
...
- peak performance schedule aşağıdaki çıktı formatını kullanarak yapılandır
