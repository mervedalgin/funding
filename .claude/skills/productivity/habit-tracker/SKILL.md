---
description: Analyze and produce a habit tracker with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir habit tracker analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut habit tracker belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- habit tracker yapılandırmak için seçilen çerçeveyi uygula
...
- habit tracker aşağıdaki çıktı formatını kullanarak yapılandır
