---
description: Create a meeting optimizer with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir meeting optimizer oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut meeting optimizer belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- meeting optimizer yapılandırmak için seçilen çerçeveyi uygula
...
- meeting optimizer aşağıdaki çıktı formatını kullanarak yapılandır
