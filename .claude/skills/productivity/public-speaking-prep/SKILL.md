---
description: Create a public speaking prep with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir public speaking prep oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut public speaking prep belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- public speaking prep yapılandırmak için seçilen çerçeveyi uygula
...
- public speaking prep aşağıdaki çıktı formatını kullanarak yapılandır
