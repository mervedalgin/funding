---
description: Create a virtual assistant brief with structured process, quality checks, and system integration
---

# Virtual Assistant Brief

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir virtual assistant brief oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut virtual assistant brief belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- virtual assistant brief yapılandırmak için seçilen çerçeveyi uygula
...
- virtual assistant brief aşağıdaki çıktı formatını kullanarak yapılandır
