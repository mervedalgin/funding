---
description: Create a eisenhower matrix with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir eisenhower matrix oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut eisenhower matrix belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- eisenhower matrix yapılandırmak için seçilen çerçeveyi uygula
...
- eisenhower matrix aşağıdaki çıktı formatını kullanarak yapılandır
