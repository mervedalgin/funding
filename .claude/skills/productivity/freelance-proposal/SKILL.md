---
description: Create a freelance proposal with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir freelance proposal oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut freelance proposal belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- freelance proposal yapılandırmak için seçilen çerçeveyi uygula
...
- freelance proposal aşağıdaki çıktı formatını kullanarak yapılandır
