---
description: Create a gratitude practice with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir gratitude practice oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut gratitude practice belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- gratitude practice yapılandırmak için seçilen çerçeveyi uygula
...
- gratitude practice aşağıdaki çıktı formatını kullanarak yapılandır
