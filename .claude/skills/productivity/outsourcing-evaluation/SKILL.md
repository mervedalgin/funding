---
description: Analyze and produce a outsourcing evaluation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir outsourcing evaluation analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut outsourcing evaluation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- outsourcing evaluation yapılandırmak için seçilen çerçeveyi uygula
...
- outsourcing evaluation aşağıdaki çıktı formatını kullanarak yapılandır
