---
description: Design and document a skill acquisition plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir skill acquisition plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut skill acquisition plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- skill acquisition plan yapılandırmak için seçilen çerçeveyi uygula
...
- skill acquisition plan aşağıdaki çıktı formatını kullanarak yapılandır
