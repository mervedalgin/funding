---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir işlemsel e-posta metni oluşturun
---

# İşlemsel E-posta Metni

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir işlemsel e-posta metni oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut işlemsel e-posta metni belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- İşlemsel e-posta metnini yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak işlemsel e-posta metnini yapılandır
