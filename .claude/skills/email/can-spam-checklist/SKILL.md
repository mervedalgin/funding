---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir CAN-SPAM kontrol listesi analiz edin ve oluşturun
---

# CAN-SPAM Kontrol Listesi

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir CAN-SPAM kontrol listesi analiz edin ve oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut CAN-SPAM kontrol listesi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- CAN-SPAM kontrol listesini yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak CAN-SPAM kontrol listesini yapılandır
