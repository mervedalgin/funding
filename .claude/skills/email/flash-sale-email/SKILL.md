---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir flaş indirim e-postası oluşturun
---

# Flaş İndirim E-postası

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir flaş indirim e-postası oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut flaş indirim e-postası belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- Flaş indirim e-postasını yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak flaş indirim e-postasını yapılandır
