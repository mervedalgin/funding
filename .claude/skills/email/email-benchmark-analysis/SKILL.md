---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir e-posta kıyaslama analizi analiz edin ve oluşturun
---

# E-posta Kıyaslama Analizi

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir e-posta kıyaslama analizi analiz edin ve oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut e-posta kıyaslama analizi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- E-posta kıyaslama analizini yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak e-posta kıyaslama analizini yapılandır
