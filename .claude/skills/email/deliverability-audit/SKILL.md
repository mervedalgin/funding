---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir teslim edilebilirlik denetimi analiz edin ve oluşturun
---

# Teslim Edilebilirlik Denetimi

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir teslim edilebilirlik denetimi analiz edin ve oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut teslim edilebilirlik denetimi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- Teslim edilebilirlik denetimini yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak teslim edilebilirlik denetimini yapılandır
