---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir hoş geldiniz dizisi oluşturun
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir hoş geldiniz dizisi oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut hoş geldiniz dizisi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- Hoş geldiniz dizisini yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak hoş geldiniz dizisini yapılandır
