---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir ürün güncelleme e-postası oluşturun
---

# Ürün Güncelleme E-postası

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ürün güncelleme e-postası oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ürün güncelleme e-postası belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- Ürün güncelleme e-postasını yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak ürün güncelleme e-postasını yapılandır
