---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir değerlendirme talebi dizisi analiz edin ve oluşturun
---

# Değerlendirme Talebi Dizisi

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir değerlendirme talebi dizisi analiz edin ve oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut değerlendirme talebi dizisi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için knowledge-base.md'yi kontrol et
...
- Değerlendirme talebi dizisini yapılandırmak için seçilen çerçeveyi uygula
...
- Aşağıdaki çıktı formatını kullanarak değerlendirme talebi dizisini yapılandır
