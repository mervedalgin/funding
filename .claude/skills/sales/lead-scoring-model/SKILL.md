---
description: Analyze and produce a lead scoring model with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir lead scoring model analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut lead scoring model belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- lead scoring model yapılandırmak için seçilen çerçeveyi uygula
...
- lead scoring model aşağıdaki çıktı formatını kullanarak yapılandır
