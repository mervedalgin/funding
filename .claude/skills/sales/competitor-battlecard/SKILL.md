---
description: Create a competitor battlecard with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir competitor battlecard oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut competitor battlecard belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- competitor battlecard yapılandırmak için seçilen çerçeveyi uygula
...
- competitor battlecard aşağıdaki çıktı formatını kullanarak yapılandır
