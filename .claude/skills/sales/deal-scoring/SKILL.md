---
description: Analyze and produce a deal scoring with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir deal scoring analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut deal scoring belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- deal scoring yapılandırmak için seçilen çerçeveyi uygula
...
- deal scoring aşağıdaki çıktı formatını kullanarak yapılandır
