---
description: Design and document a cross sell playbook with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir cross sell playbook tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut cross sell playbook belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- cross sell playbook yapılandırmak için seçilen çerçeveyi uygula
...
- cross sell playbook aşağıdaki çıktı formatını kullanarak yapılandır
