---
description: Design and document a channel partner strategy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir channel partner strategy tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut channel partner strategy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- channel partner strategy yapılandırmak için seçilen çerçeveyi uygula
...
- channel partner strategy aşağıdaki çıktı formatını kullanarak yapılandır
