---
description: Design and document a executive sponsor plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir executive sponsor plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut executive sponsor plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- executive sponsor plan yapılandırmak için seçilen çerçeveyi uygula
...
- executive sponsor plan aşağıdaki çıktı formatını kullanarak yapılandır
