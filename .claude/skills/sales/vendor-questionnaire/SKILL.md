---
description: Create a vendor questionnaire with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir vendor questionnaire oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut vendor questionnaire belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- vendor questionnaire yapılandırmak için seçilen çerçeveyi uygula
...
- vendor questionnaire aşağıdaki çıktı formatını kullanarak yapılandır
