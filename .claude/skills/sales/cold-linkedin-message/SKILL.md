---
description: Create a cold linkedin message with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir cold linkedin message oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut cold linkedin message belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- cold linkedin message yapılandırmak için seçilen çerçeveyi uygula
...
- cold linkedin message aşağıdaki çıktı formatını kullanarak yapılandır
