---
description: Create a sales meeting prep with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir sales meeting prep oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut sales meeting prep belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- sales meeting prep yapılandırmak için seçilen çerçeveyi uygula
...
- sales meeting prep aşağıdaki çıktı formatını kullanarak yapılandır
