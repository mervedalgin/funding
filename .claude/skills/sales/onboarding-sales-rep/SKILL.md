---
description: Create a onboarding sales rep with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir onboarding sales rep oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut onboarding sales rep belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- onboarding sales rep yapılandırmak için seçilen çerçeveyi uygula
...
- onboarding sales rep aşağıdaki çıktı formatını kullanarak yapılandır
