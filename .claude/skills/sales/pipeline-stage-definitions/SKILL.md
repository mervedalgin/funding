---
description: Design and document a pipeline stage definitions with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir pipeline stage definitions tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut pipeline stage definitions belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- pipeline stage definitions yapılandırmak için seçilen çerçeveyi uygula
...
- pipeline stage definitions aşağıdaki çıktı formatını kullanarak yapılandır
