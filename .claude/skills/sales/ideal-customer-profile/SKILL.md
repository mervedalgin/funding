---
description: Create a ideal customer profile with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ideal customer profile oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ideal customer profile belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ideal customer profile yapılandırmak için seçilen çerçeveyi uygula
...
- ideal customer profile aşağıdaki çıktı formatını kullanarak yapılandır
