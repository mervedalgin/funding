---
description: Create a buyer persona sales with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir buyer persona sales oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut buyer persona sales belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- buyer persona sales yapılandırmak için seçilen çerçeveyi uygula
...
- buyer persona sales aşağıdaki çıktı formatını kullanarak yapılandır
