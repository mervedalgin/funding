---
description: Create a newsletter welcome series with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir newsletter welcome series oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut newsletter welcome series belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- newsletter welcome series yapılandırmak için seçilen çerçeveyi uygula
...
- newsletter welcome series aşağıdaki çıktı formatını kullanarak yapılandır
