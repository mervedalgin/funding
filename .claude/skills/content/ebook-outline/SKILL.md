...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ebook outline oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ebook outline belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ebook outline yapılandırmak için seçilen çerçeveyi uygula
...
- ebook outline aşağıdaki çıktı formatını kullanarak yapılandır
