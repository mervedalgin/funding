---
description: Analyze and produce a microcopy audit with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir microcopy audit analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut microcopy audit belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- microcopy audit yapılandırmak için seçilen çerçeveyi uygula
...
- microcopy audit aşağıdaki çıktı formatını kullanarak yapılandır
