---
description: Analyze and produce a feature comparison with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir feature comparison analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut feature comparison belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- feature comparison yapılandırmak için seçilen çerçeveyi uygula
...
- feature comparison aşağıdaki çıktı formatını kullanarak yapılandır
