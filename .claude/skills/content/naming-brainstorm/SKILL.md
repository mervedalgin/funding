---
description: Create a naming brainstorm with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir naming brainstorm oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut naming brainstorm belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- naming brainstorm yapılandırmak için seçilen çerçeveyi uygula
...
- naming brainstorm aşağıdaki çıktı formatını kullanarak yapılandır
