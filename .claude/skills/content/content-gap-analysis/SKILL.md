---
description: Analyze and produce a content gap analysis with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir content gap analysis analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut content gap analysis belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- content gap analysis yapılandırmak için seçilen çerçeveyi uygula
...
- content gap analysis aşağıdaki çıktı formatını kullanarak yapılandır
