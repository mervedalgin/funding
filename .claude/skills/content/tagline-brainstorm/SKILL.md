---
description: Create a tagline brainstorm with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir tagline brainstorm oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut tagline brainstorm belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- tagline brainstorm yapılandırmak için seçilen çerçeveyi uygula
...
- tagline brainstorm aşağıdaki çıktı formatını kullanarak yapılandır
