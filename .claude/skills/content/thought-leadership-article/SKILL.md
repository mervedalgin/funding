---
description: Create a thought leadership article with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir thought leadership article oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut thought leadership article belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- thought leadership article yapılandırmak için seçilen çerçeveyi uygula
...
- thought leadership article aşağıdaki çıktı formatını kullanarak yapılandır
