---
description: Design and document a blog content calendar with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir blog content calendar tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut blog content calendar belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- blog content calendar yapılandırmak için seçilen çerçeveyi uygula
...
- blog content calendar aşağıdaki çıktı formatını kullanarak yapılandır
