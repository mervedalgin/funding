---
description: Create a podcast show notes with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir podcast show notes oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut podcast show notes belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- podcast show notes yapılandırmak için seçilen çerçeveyi uygula
...
- podcast show notes aşağıdaki çıktı formatını kullanarak yapılandır
