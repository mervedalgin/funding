---
description: Create a email sequence copy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir email sequence copy oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut email sequence copy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- email sequence copy yapılandırmak için seçilen çerçeveyi uygula
...
- email sequence copy aşağıdaki çıktı formatını kullanarak yapılandır
