---
description: Create a business proposal copy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir business proposal copy oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut business proposal copy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- business proposal copy yapılandırmak için seçilen çerçeveyi uygula
...
- business proposal copy aşağıdaki çıktı formatını kullanarak yapılandır
