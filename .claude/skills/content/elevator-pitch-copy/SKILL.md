---
description: Create a elevator pitch copy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir elevator pitch copy oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut elevator pitch copy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- elevator pitch copy yapılandırmak için seçilen çerçeveyi uygula
...
- elevator pitch copy aşağıdaki çıktı formatını kullanarak yapılandır
