---
description: Analyze and produce a annual report narrative with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir annual report narrative analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut annual report narrative belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- annual report narrative yapılandırmak için seçilen çerçeveyi uygula
...
- annual report narrative aşağıdaki çıktı formatını kullanarak yapılandır
