---
description: Create a sponsorship proposal with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir sponsorship proposal oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut sponsorship proposal belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- sponsorship proposal yapılandırmak için seçilen çerçeveyi uygula
...
- sponsorship proposal aşağıdaki çıktı formatını kullanarak yapılandır
