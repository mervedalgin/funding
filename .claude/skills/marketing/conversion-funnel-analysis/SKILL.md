---
description: Analyze and produce a conversion funnel analysis with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir conversion funnel analysis analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut conversion funnel analysis belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- conversion funnel analysis yapılandırmak için seçilen çerçeveyi uygula
...
- conversion funnel analysis aşağıdaki çıktı formatını kullanarak yapılandır
