---
description: Create a elevator pitch with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir elevator pitch oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut elevator pitch belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- elevator pitch yapılandırmak için seçilen çerçeveyi uygula
...
- elevator pitch aşağıdaki çıktı formatını kullanarak yapılandır
