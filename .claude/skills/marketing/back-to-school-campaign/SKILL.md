---
description: Design and document a back to school campaign with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir back to school campaign tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut back to school campaign belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- back to school campaign yapılandırmak için seçilen çerçeveyi uygula
...
- back to school campaign aşağıdaki çıktı formatını kullanarak yapılandır
