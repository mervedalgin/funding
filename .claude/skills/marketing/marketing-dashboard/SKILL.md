---
description: Analyze and produce a marketing dashboard with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir marketing dashboard analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut marketing dashboard belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- marketing dashboard yapılandırmak için seçilen çerçeveyi uygula
...
- marketing dashboard aşağıdaki çıktı formatını kullanarak yapılandır
