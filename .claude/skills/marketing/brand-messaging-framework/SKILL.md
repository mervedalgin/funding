---
description: Design and document a brand messaging framework with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir brand messaging framework tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut brand messaging framework belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- brand messaging framework yapılandırmak için seçilen çerçeveyi uygula
...
- brand messaging framework aşağıdaki çıktı formatını kullanarak yapılandır
