---
description: Design and document a holiday marketing plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir holiday marketing plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut holiday marketing plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- holiday marketing plan yapılandırmak için seçilen çerçeveyi uygula
...
- holiday marketing plan aşağıdaki çıktı formatını kullanarak yapılandır
