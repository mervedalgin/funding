---
description: Analyze and produce a marketing stack audit with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir marketing stack audit analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut marketing stack audit belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- marketing stack audit yapılandırmak için seçilen çerçeveyi uygula
...
- marketing stack audit aşağıdaki çıktı formatını kullanarak yapılandır
