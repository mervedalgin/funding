---
description: Design and document a campaign retrospective with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir campaign retrospective tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut campaign retrospective belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- campaign retrospective yapılandırmak için seçilen çerçeveyi uygula
...
- campaign retrospective aşağıdaki çıktı formatını kullanarak yapılandır
