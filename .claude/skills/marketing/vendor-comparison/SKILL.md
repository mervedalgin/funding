---
description: Analyze and produce a vendor comparison with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir vendor comparison analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut vendor comparison belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- vendor comparison yapılandırmak için seçilen çerçeveyi uygula
...
- vendor comparison aşağıdaki çıktı formatını kullanarak yapılandır
