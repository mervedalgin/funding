---
description: Analyze and produce a martech evaluation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir martech evaluation analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut martech evaluation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- martech evaluation yapılandırmak için seçilen çerçeveyi uygula
...
- martech evaluation aşağıdaki çıktı formatını kullanarak yapılandır
