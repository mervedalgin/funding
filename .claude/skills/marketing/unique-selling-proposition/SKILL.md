---
description: Create a unique selling proposition with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir unique selling proposition oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut unique selling proposition belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- unique selling proposition yapılandırmak için seçilen çerçeveyi uygula
...
- unique selling proposition aşağıdaki çıktı formatını kullanarak yapılandır
