---
description: Create a guerrilla marketing with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir guerrilla marketing oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut guerrilla marketing belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- guerrilla marketing yapılandırmak için seçilen çerçeveyi uygula
...
- guerrilla marketing aşağıdaki çıktı formatını kullanarak yapılandır
