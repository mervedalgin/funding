---
description: Design and document a b2c marketing plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir b2c marketing plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut b2c marketing plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- b2c marketing plan yapılandırmak için seçilen çerçeveyi uygula
...
- b2c marketing plan aşağıdaki çıktı formatını kullanarak yapılandır
