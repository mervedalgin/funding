---
description: Design and document a seasonal campaign with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir seasonal campaign tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut seasonal campaign belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- seasonal campaign yapılandırmak için seçilen çerçeveyi uygula
...
- seasonal campaign aşağıdaki çıktı formatını kullanarak yapılandır
