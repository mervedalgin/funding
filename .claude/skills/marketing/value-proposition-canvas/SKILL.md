---
description: Create a value proposition canvas with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir value proposition canvas oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut value proposition canvas belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- value proposition canvas yapılandırmak için seçilen çerçeveyi uygula
...
- value proposition canvas aşağıdaki çıktı formatını kullanarak yapılandır
