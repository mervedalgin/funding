---
description: Analyze and produce a touchpoint audit with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir touchpoint audit analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut touchpoint audit belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- touchpoint audit yapılandırmak için seçilen çerçeveyi uygula
...
- touchpoint audit aşağıdaki çıktı formatını kullanarak yapılandır
