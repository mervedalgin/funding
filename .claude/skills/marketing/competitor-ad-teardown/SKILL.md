---
description: Analyze and produce a competitor ad teardown with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir competitor ad teardown analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut competitor ad teardown belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- competitor ad teardown yapılandırmak için seçilen çerçeveyi uygula
...
- competitor ad teardown aşağıdaki çıktı formatını kullanarak yapılandır
