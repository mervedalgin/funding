---
description: Design and document a brand guidelines with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir brand guidelines tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut brand guidelines belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- brand guidelines yapılandırmak için seçilen çerçeveyi uygula
...
- brand guidelines aşağıdaki çıktı formatını kullanarak yapılandır
