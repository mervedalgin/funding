---
description: Analyze and produce a inclusive design checklist with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir inclusive design checklist analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut inclusive design checklist belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- inclusive design checklist yapılandırmak için seçilen çerçeveyi uygula
...
- inclusive design checklist aşağıdaki çıktı formatını kullanarak yapılandır
