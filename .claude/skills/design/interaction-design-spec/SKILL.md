---
description: Create a interaction design spec with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir interaction design spec oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut interaction design spec belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- interaction design spec yapılandırmak için seçilen çerçeveyi uygula
...
- interaction design spec aşağıdaki çıktı formatını kullanarak yapılandır
