---
description: Create a video direction brief with structured process, quality checks, and system integration
---

# Video Direction Brief

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir video direction brief oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut video direction brief belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- video direction brief yapılandırmak için seçilen çerçeveyi uygula
...
- video direction brief aşağıdaki çıktı formatını kullanarak yapılandır
