---
description: Create a wireframe spec with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir wireframe spec oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut wireframe spec belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- wireframe spec yapılandırmak için seçilen çerçeveyi uygula
...
- wireframe spec aşağıdaki çıktı formatını kullanarak yapılandır
