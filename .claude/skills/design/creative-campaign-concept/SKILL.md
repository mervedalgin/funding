---
description: Design and document a creative campaign concept with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir creative campaign concept tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut creative campaign concept belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- creative campaign concept yapılandırmak için seçilen çerçeveyi uygula
...
- creative campaign concept aşağıdaki çıktı formatını kullanarak yapılandır
