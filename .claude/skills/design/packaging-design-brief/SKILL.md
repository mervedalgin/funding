---
description: Create a packaging design brief with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir packaging design brief oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut packaging design brief belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- packaging design brief yapılandırmak için seçilen çerçeveyi uygula
...
- packaging design brief aşağıdaki çıktı formatını kullanarak yapılandır
