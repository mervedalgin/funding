---
description: Design and document a brand guidelines doc with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir brand guidelines doc tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut brand guidelines doc belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- brand guidelines doc yapılandırmak için seçilen çerçeveyi uygula
...
- brand guidelines doc aşağıdaki çıktı formatını kullanarak yapılandır
