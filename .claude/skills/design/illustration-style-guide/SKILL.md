---
description: Design and document a illustration style guide with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir illustration style guide tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut illustration style guide belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- illustration style guide yapılandırmak için seçilen çerçeveyi uygula
...
- illustration style guide aşağıdaki çıktı formatını kullanarak yapılandır
