---
description: Create a photo direction brief with structured process, quality checks, and system integration
---

# Photo Direction Brief

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir photo direction brief oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut photo direction brief belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- photo direction brief yapılandırmak için seçilen çerçeveyi uygula
...
- photo direction brief aşağıdaki çıktı formatını kullanarak yapılandır
