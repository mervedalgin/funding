---
description: Create a design thinking workshop with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir design thinking workshop oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut design thinking workshop belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- design thinking workshop yapılandırmak için seçilen çerçeveyi uygula
...
- design thinking workshop aşağıdaki çıktı formatını kullanarak yapılandır
