---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir sertifikasyon programı tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir sertifikasyon programı tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut sertifikasyon programı belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Sertifikasyon programını yapılandırmak için seçilen çerçeveyi uygula
...
- Sertifikasyon programını aşağıdaki çıktı formatını kullanarak yapılandır
