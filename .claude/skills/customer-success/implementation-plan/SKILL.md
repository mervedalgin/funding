---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir uygulama planı tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir implementation plan tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut implementation plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Implementation Plan çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Implementation Plan çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
