---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir SLA tanımı oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir sla definition oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut sla definition belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Sla Definition çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Sla Definition çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
