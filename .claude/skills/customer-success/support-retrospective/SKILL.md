---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir destek retrospektifi oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir support retrospective oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut support retrospective belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Support Retrospective çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Support Retrospective çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
