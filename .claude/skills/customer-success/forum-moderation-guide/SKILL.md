---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir forum moderasyon rehberi tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir forum moderation guide tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut forum moderation guide belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Forum Moderation Guide çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Forum Moderation Guide çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
