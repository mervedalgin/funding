---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir kayıp önleme rehberi tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir kayıp önleme rehberi tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut kayıp önleme rehberi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Kayıp önleme rehberini yapılandırmak için seçilen çerçeveyi uygula
...
- Kayıp önleme rehberini aşağıdaki çıktı formatını kullanarak yapılandır
