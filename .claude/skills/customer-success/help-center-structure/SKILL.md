---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir yardım merkezi yapısı oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir help center structure oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut help center structure belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Help Center Structure çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Help Center Structure çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
