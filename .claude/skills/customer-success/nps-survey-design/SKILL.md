---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir NPS anket tasarımı oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir nps survey design oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut nps survey design belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Nps Survey Design çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Nps Survey Design çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
