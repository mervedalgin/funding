---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir müşteri başarısı iletişim planı tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir müşteri başarısı iletişim planı tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Bu çıktıyla ilgili `Task Board.md`'deki aktif görevleri not et

## Süreç

### Adım 1: Bağlam ve Araştırma
- Projedeki mevcut müşteri başarısı iletişim planı belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Müşteri başarısı iletişim planını yapılandırmak için seçilen çerçeveyi uygula
...
- Müşteri başarısı iletişim planını aşağıdaki çıktı formatını kullanarak yapılandır
...
- Takip eylemleri belirlendiyse `Task Board.md`'ye ekle
