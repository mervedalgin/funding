---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir topluluk yönetimi oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir topluluk yönetimi oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut topluluk yönetimi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Topluluk yönetimini yapılandırmak için seçilen çerçeveyi uygula
...
- Topluluk yönetimini aşağıdaki çıktı formatını kullanarak yapılandır
