---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir eskalasyon prosedürü oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir escalation procedure oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut escalation procedure belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Escalation Procedure çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Escalation Procedure çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
