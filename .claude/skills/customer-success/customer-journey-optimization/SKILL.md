---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir müşteri yolculuğu optimizasyonu oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir müşteri yolculuğu optimizasyonu oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut müşteri yolculuğu optimizasyonu belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Müşteri yolculuğu optimizasyonunu yapılandırmak için seçilen çerçeveyi uygula
...
- Müşteri yolculuğu optimizasyonunu aşağıdaki çıktı formatını kullanarak yapılandır
