---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir kayıp riski analizi analiz et ve üret
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir kayıp riski analizini analiz et ve üret. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut kayıp riski analizi belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Kayıp riski analizini yapılandırmak için seçilen çerçeveyi uygula
...
- Kayıp riski analizini aşağıdaki çıktı formatını kullanarak yapılandır
