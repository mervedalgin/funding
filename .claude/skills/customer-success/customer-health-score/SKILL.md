---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir müşteri sağlık puanı oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir müşteri sağlık puanı oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut müşteri sağlık puanı belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Müşteri sağlık puanını yapılandırmak için seçilen çerçeveyi uygula
...
- Müşteri sağlık puanını aşağıdaki çıktı formatını kullanarak yapılandır
