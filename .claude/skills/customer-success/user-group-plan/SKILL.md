---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir kullanıcı grubu planı tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir user group plan tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut user group plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- User Group Plan çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- User Group Plan çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
