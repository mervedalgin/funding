---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir özellik duyurusu oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir feature announcement oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut feature announcement belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Feature Announcement çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Feature Announcement çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
