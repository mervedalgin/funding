---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir müşteri geri bildirim döngüsü oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir müşteri geri bildirim döngüsü oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut müşteri geri bildirim döngüsü belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Müşteri geri bildirim döngüsünü yapılandırmak için seçilen çerçeveyi uygula
...
- Müşteri geri bildirim döngüsünü aşağıdaki çıktı formatını kullanarak yapılandır
