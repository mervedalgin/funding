---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir yapay zeka destek kurulumu tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir yapay zeka destek kurulumu tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut yapay zeka destek kurulumu belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Yapay zeka destek kurulumunu yapılandırmak için seçilen çerçeveyi uygula
...
- Yapay zeka destek kurulumunu aşağıdaki çıktı formatını kullanarak yapılandır
