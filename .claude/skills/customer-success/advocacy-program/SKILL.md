---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir savunuculuk programı tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir savunuculuk programı tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut savunuculuk programı belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Savunuculuk programını yapılandırmak için seçilen çerçeveyi uygula
...
- Savunuculuk programını aşağıdaki çıktı formatını kullanarak yapılandır
