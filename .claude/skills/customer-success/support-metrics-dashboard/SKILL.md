...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir support metrics dashboard analiz et ve üret. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut support metrics dashboard belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Support Metrics Dashboard çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Support Metrics Dashboard çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
