---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir self servis stratejisi tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir self service strategy tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut self service strategy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Self Service Strategy çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Self Service Strategy çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
