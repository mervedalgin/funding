---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir geri bildirim sınıflandırması oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir feedback categorization oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut feedback categorization belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Feedback Categorization çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Feedback Categorization çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
