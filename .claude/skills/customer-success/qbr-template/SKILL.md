---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir QBR şablonu oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir qbr template oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut qbr template belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Qbr Template çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Qbr Template çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
