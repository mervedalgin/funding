---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir destek bileti şablonu oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir support ticket template oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut support ticket template belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Support Ticket Template çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Support Ticket Template çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
