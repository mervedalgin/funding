---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir müşteri efor puanı oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir müşteri efor puanı oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut müşteri efor puanı belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Müşteri efor puanını yapılandırmak için seçilen çerçeveyi uygula
...
- Müşteri efor puanını aşağıdaki çıktı formatını kullanarak yapılandır
