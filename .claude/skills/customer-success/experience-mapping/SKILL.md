---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir deneyim haritalama oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir experience mapping oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut experience mapping belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Experience Mapping çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Experience Mapping çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
