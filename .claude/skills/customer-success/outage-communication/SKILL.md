---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir kesinti iletişimi oluştur
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir outage communication oluştur. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut outage communication belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Outage Communication çıktısını yapılandırmak için seçilen çerçeveyi uygula
...
- Outage Communication çıktısını aşağıdaki çıktı formatını kullanarak yapılandır
