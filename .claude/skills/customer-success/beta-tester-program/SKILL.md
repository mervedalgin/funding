---
description: Yapılandırılmış süreç, kalite kontrolleri ve sistem entegrasyonu ile bir beta test programı tasarla ve belgele
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir beta test programı tasarla ve belgele. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut beta test programı belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- Beta test programını yapılandırmak için seçilen çerçeveyi uygula
...
- Beta test programını aşağıdaki çıktı formatını kullanarak yapılandır
