---
description: Design and document a cross platform strategy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir cross platform strategy tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut cross platform strategy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- cross platform strategy yapılandırmak için seçilen çerçeveyi uygula
...
- cross platform strategy aşağıdaki çıktı formatını kullanarak yapılandır
