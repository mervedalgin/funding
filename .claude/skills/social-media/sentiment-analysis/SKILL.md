---
description: Analyze and produce a sentiment analysis with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir sentiment analysis analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut sentiment analysis belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- sentiment analysis yapılandırmak için seçilen çerçeveyi uygula
...
- sentiment analysis aşağıdaki çıktı formatını kullanarak yapılandır
