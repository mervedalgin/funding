---
description: Create a instagram carousel with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir instagram carousel oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut instagram carousel belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- instagram carousel yapılandırmak için seçilen çerçeveyi uygula
...
- instagram carousel aşağıdaki çıktı formatını kullanarak yapılandır
