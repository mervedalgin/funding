---
description: Create a youtube shorts script with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir youtube shorts script oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut youtube shorts script belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- youtube shorts script yapılandırmak için seçilen çerçeveyi uygula
...
- youtube shorts script aşağıdaki çıktı formatını kullanarak yapılandır
