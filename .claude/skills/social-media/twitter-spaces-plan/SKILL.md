---
description: Design and document a twitter spaces plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir twitter spaces plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut twitter spaces plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- twitter spaces plan yapılandırmak için seçilen çerçeveyi uygula
...
- twitter spaces plan aşağıdaki çıktı formatını kullanarak yapılandır
