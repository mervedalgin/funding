---
description: Design and document a tiktok series plan with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir tiktok series plan tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut tiktok series plan belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- tiktok series plan yapılandırmak için seçilen çerçeveyi uygula
...
- tiktok series plan aşağıdaki çıktı formatını kullanarak yapılandır
