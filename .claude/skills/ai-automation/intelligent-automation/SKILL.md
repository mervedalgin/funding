---
description: Create a intelligent automation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir intelligent automation oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut intelligent automation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- intelligent automation yapılandırmak için seçilen çerçeveyi uygula
...
- intelligent automation aşağıdaki çıktı formatını kullanarak yapılandır
