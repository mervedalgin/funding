...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai image prompt oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai image prompt belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai image prompt yapılandırmak için seçilen çerçeveyi uygula
...
- ai image prompt aşağıdaki çıktı formatını kullanarak yapılandır
