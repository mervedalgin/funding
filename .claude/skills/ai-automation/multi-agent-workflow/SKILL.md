---
description: Design and document a multi agent workflow with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir multi agent workflow tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut multi agent workflow belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- multi agent workflow yapılandırmak için seçilen çerçeveyi uygula
...
- multi agent workflow aşağıdaki çıktı formatını kullanarak yapılandır
