---
description: Analyze and produce a ai vendor evaluation with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai vendor evaluation analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai vendor evaluation belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai vendor evaluation yapılandırmak için seçilen çerçeveyi uygula
...
- ai vendor evaluation aşağıdaki çıktı formatını kullanarak yapılandır
