---
description: Analyze and produce a ai readiness assessment with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai readiness assessment analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai readiness assessment belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai readiness assessment yapılandırmak için seçilen çerçeveyi uygula
...
- ai readiness assessment aşağıdaki çıktı formatını kullanarak yapılandır
