---
description: Create a automation opportunity map with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir automation opportunity map oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut automation opportunity map belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- automation opportunity map yapılandırmak için seçilen çerçeveyi uygula
...
- automation opportunity map aşağıdaki çıktı formatını kullanarak yapılandır
