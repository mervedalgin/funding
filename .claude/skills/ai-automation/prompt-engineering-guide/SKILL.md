---
description: Design and document a prompt engineering guide with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir prompt engineering guide tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut prompt engineering guide belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- prompt engineering guide yapılandırmak için seçilen çerçeveyi uygula
...
- prompt engineering guide aşağıdaki çıktı formatını kullanarak yapılandır
