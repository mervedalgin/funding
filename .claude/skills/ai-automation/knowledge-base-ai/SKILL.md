---
description: Create a knowledge base ai with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir knowledge base ai oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut knowledge base ai belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- knowledge base ai yapılandırmak için seçilen çerçeveyi uygula
...
- knowledge base ai aşağıdaki çıktı formatını kullanarak yapılandır
