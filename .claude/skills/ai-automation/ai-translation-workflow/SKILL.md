---
description: Design and document a ai translation workflow with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai translation workflow tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai translation workflow belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai translation workflow yapılandırmak için seçilen çerçeveyi uygula
...
- ai translation workflow aşağıdaki çıktı formatını kullanarak yapılandır
