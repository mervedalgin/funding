---
description: Analyze and produce a llm comparison with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir llm comparison analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut llm comparison belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- llm comparison yapılandırmak için seçilen çerçeveyi uygula
...
- llm comparison aşağıdaki çıktı formatını kullanarak yapılandır
