---
description: Create a ai email drafting with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai email drafting oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai email drafting belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai email drafting yapılandırmak için seçilen çerçeveyi uygula
...
- ai email drafting aşağıdaki çıktı formatını kullanarak yapılandır
