---
description: Create a ai assistant spec with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai assistant spec oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai assistant spec belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai assistant spec yapılandırmak için seçilen çerçeveyi uygula
...
- ai assistant spec aşağıdaki çıktı formatını kullanarak yapılandır
