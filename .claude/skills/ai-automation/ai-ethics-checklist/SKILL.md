---
description: Analyze and produce a ai ethics checklist with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir ai ethics checklist analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut ai ethics checklist belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- ai ethics checklist yapılandırmak için seçilen çerçeveyi uygula
...
- ai ethics checklist aşağıdaki çıktı formatını kullanarak yapılandır
