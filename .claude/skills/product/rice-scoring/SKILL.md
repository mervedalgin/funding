---
description: Analyze and produce a rice scoring with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir rice scoring analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut rice scoring belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- rice scoring yapılandırmak için seçilen çerçeveyi uygula
...
- rice scoring aşağıdaki çıktı formatını kullanarak yapılandır
