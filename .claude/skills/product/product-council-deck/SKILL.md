---
description: Create a product council deck with structured process, quality checks, and system integration
---

# Product Council Deck

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir product council deck oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut product council deck belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- product council deck yapılandırmak için seçilen çerçeveyi uygula
...
- product council deck aşağıdaki çıktı formatını kullanarak yapılandır
