---
description: Create a product onboarding flow with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir product onboarding flow oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut product onboarding flow belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- product onboarding flow yapılandırmak için seçilen çerçeveyi uygula
...
- product onboarding flow aşağıdaki çıktı formatını kullanarak yapılandır
