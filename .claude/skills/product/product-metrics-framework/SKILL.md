---
description: Analyze and produce a product metrics framework with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir product metrics framework analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut product metrics framework belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- product metrics framework yapılandırmak için seçilen çerçeveyi uygula
...
- product metrics framework aşağıdaki çıktı formatını kullanarak yapılandır
