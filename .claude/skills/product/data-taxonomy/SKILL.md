---
description: Create a data taxonomy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir data taxonomy oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut data taxonomy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- data taxonomy yapılandırmak için seçilen çerçeveyi uygula
...
- data taxonomy aşağıdaki çıktı formatını kullanarak yapılandır
