---
description: Create a board product update with structured process, quality checks, and system integration
---

# Board Product Update

## Amaç

Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir board product update oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut board product update belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- board product update yapılandırmak için seçilen çerçeveyi uygula
...
- board product update aşağıdaki çıktı formatını kullanarak yapılandır
