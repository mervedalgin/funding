---
description: Create a acceptance criteria with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir acceptance criteria oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut acceptance criteria belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- acceptance criteria yapılandırmak için seçilen çerçeveyi uygula
...
- acceptance criteria aşağıdaki çıktı formatını kullanarak yapılandır
