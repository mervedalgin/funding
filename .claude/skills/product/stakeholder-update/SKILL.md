---
description: Create a stakeholder update with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir stakeholder update oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut stakeholder update belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- stakeholder update yapılandırmak için seçilen çerçeveyi uygula
...
- stakeholder update aşağıdaki çıktı formatını kullanarak yapılandır
