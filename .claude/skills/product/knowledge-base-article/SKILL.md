---
description: Create a knowledge base article with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir knowledge base article oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut knowledge base article belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- knowledge base article yapılandırmak için seçilen çerçeveyi uygula
...
- knowledge base article aşağıdaki çıktı formatını kullanarak yapılandır
