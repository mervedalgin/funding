---
description: Analyze and produce a activation checklist with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir activation checklist analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut activation checklist belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- activation checklist yapılandırmak için seçilen çerçeveyi uygula
...
- activation checklist aşağıdaki çıktı formatını kullanarak yapılandır
