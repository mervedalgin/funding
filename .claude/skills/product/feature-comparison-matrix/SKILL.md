---
description: Analyze and produce a feature comparison matrix with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir feature comparison matrix analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut feature comparison matrix belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- feature comparison matrix yapılandırmak için seçilen çerçeveyi uygula
...
- feature comparison matrix aşağıdaki çıktı formatını kullanarak yapılandır
