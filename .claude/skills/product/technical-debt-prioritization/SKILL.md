---
description: Create a technical debt prioritization with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir technical debt prioritization oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut technical debt prioritization belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- technical debt prioritization yapılandırmak için seçilen çerçeveyi uygula
...
- technical debt prioritization aşağıdaki çıktı formatını kullanarak yapılandır
