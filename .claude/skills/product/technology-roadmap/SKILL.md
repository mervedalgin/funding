---
description: Design and document a technology roadmap with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir technology roadmap tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut technology roadmap belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- technology roadmap yapılandırmak için seçilen çerçeveyi uygula
...
- technology roadmap aşağıdaki çıktı formatını kullanarak yapılandır
