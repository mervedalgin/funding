---
description: Create a feedback taxonomy with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir feedback taxonomy oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut feedback taxonomy belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- feedback taxonomy yapılandırmak için seçilen çerçeveyi uygula
...
- feedback taxonomy aşağıdaki çıktı formatını kullanarak yapılandır
