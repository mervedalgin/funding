---
description: Analyze and produce a growth metrics with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir growth metrics analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut growth metrics belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- growth metrics yapılandırmak için seçilen çerçeveyi uygula
...
- growth metrics aşağıdaki çıktı formatını kullanarak yapılandır
