---
description: Create a hiring first ten with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir hiring first ten oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut hiring first ten belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- hiring first ten yapılandırmak için seçilen çerçeveyi uygula
...
- hiring first ten aşağıdaki çıktı formatını kullanarak yapılandır
