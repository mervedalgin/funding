---
description: Create a mvp feature list with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir mvp feature list oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut mvp feature list belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- mvp feature list yapılandırmak için seçilen çerçeveyi uygula
...
- mvp feature list aşağıdaki çıktı formatını kullanarak yapılandır
