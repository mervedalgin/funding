---
description: Design and document a remote startup playbook with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir remote startup playbook tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut remote startup playbook belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- remote startup playbook yapılandırmak için seçilen çerçeveyi uygula
...
- remote startup playbook aşağıdaki çıktı formatını kullanarak yapılandır
