---
description: Create a mentor outreach with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir mentor outreach oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut mentor outreach belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- mentor outreach yapılandırmak için seçilen çerçeveyi uygula
...
- mentor outreach aşağıdaki çıktı formatını kullanarak yapılandır
