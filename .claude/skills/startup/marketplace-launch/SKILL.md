---
description: Create a marketplace launch with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir marketplace launch oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut marketplace launch belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- marketplace launch yapılandırmak için seçilen çerçeveyi uygula
...
- marketplace launch aşağıdaki çıktı formatını kullanarak yapılandır
