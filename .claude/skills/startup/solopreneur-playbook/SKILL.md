---
description: Design and document a solopreneur playbook with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir solopreneur playbook tasarlayın ve belgeleyin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut solopreneur playbook belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- solopreneur playbook yapılandırmak için seçilen çerçeveyi uygula
...
- solopreneur playbook aşağıdaki çıktı formatını kullanarak yapılandır
