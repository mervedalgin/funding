---
description: Analyze and produce a startup metrics dashboard with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir startup metrics dashboard analiz edin ve üretin. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut startup metrics dashboard belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- startup metrics dashboard yapılandırmak için seçilen çerçeveyi uygula
...
- startup metrics dashboard aşağıdaki çıktı formatını kullanarak yapılandır
