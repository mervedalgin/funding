---
description: Create a competitive landscape with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir competitive landscape oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut competitive landscape belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- competitive landscape yapılandırmak için seçilen çerçeveyi uygula
...
- competitive landscape aşağıdaki çıktı formatını kullanarak yapılandır
