---
description: Create a acquisition prep with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir acquisition prep oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut acquisition prep belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- acquisition prep yapılandırmak için seçilen çerçeveyi uygula
...
- acquisition prep aşağıdaki çıktı formatını kullanarak yapılandır
