---
description: Create a due diligence prep with structured process, quality checks, and system integration
---
...
Eyleme dönüştürülebilir, ölçülebilir sonuçlar sunan kapsamlı bir due diligence prep oluşturun. Bu beceri, her seferinde profesyonel düzeyde çıktı sağlayan, kalite doğrulamalı yapılandırılmış bir süreç sunar.
...
- Projedeki mevcut due diligence prep belgelerini gözden geçir
- İlgili öğrenilmiş kurallar veya kısıtlamalar için `knowledge-base.md`'yi kontrol et
...
- due diligence prep yapılandırmak için seçilen çerçeveyi uygula
...
- due diligence prep aşağıdaki çıktı formatını kullanarak yapılandır
